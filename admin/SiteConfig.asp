...
<form method="POST" action="SiteConfig.asp" id="form" name="form">
  <table width="650" border="0" align="center" cellpadding="2" cellspacing="1" bgcolor="#000000" >
    ...
    <tr bgcolor="#FFFFFF"> 
      <td class="tdbg"><strong>网站标题(英文-中文版用户不需改动)：</strong></td>
    ...
    <tr bgcolor="#FFFFFF"> 
      <td class="tdbg"><strong>网站名称(英文-中文版用户不需改动)：</strong></td>
    ...
    <tr bgcolor="#FFFFFF">
      <td height="22" class="table_southidc" style="font-weight: bold">首页左下侧 地址 </td>
      <td colspan="3" class="tdbg"><input name="Indexadd" type="text" id="Indexadd" value="<%=Indexadd%>" size="40" maxlength="255"></td>
    </tr>
    <tr bgcolor="#FFFFFF">
      <td height="22" class="table_southidc" style="font-weight: bold">首页左下侧 电话</td>
      <td colspan="3" class="tdbg"><input name="Indextel" type="text" id="Indextel" value="<%=Indextel%>" size="40" maxlength="255"></td>
    </tr>
    <tr bgcolor="#FFFFFF">
      <td height="22" class="table_southidc" style="font-weight: bold">首页左下侧 传真 </td>
      <td colspan="3" class="tdbg"><input name="Indexfax" type="text" id="Indexfax" value="<%=Indexfax%>" size="40" maxlength="255"></td>
    </tr>
    <tr bgcolor="#FFFFFF"> 
    ...
    <tr bgcolor="#FFFFFF"> 
      <td width="224" class="tdbg"><strong>版权信息(英文)：</strong><br>
        <p><span style="color: #FF0000">支持HTML标记，不能使用双引号</span></p>
      <p style="color: #FF0000">不支持Enter换行，如前台需要显示换行，请在需要换行的文字前加 <span style="color: #000000">&lt;br&gt;</span></p></td>
      <td colspan="3" class="tdbg"><textarea name="EnCopyright" cols="50" rows="8" id="EnCopyright"><%=EnCopyright%></textarea>      </td>
    </tr>
    <tr bgcolor="#FFFFFF"> 
...
sub SaveConfig()
	...
	hf.write "Const Indexadd=" & chr(34) & trim(request("Indexadd")) & chr(34) & "        '网站地址" & vbcrlf
	hf.write "Const Indextel=" & chr(34) & trim(request("Indextel")) & chr(34) & "        '网站地址" & vbcrlf
	hf.write "Const Indexfax=" & chr(34) & trim(request("Indexfax")) & chr(34) & "        '网站地址" & vbcrlf
