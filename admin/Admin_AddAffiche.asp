...
<input name="title" type="text" size="45" maxlength="100">
				   ...
				   <tr> 
                    <td width="22%" height="25" bgcolor="#A4B6D7"> 
                      <div align="center">英文标题:</div></td>
                    <td width="78%">
<input name="entitle" type="text" size="45" maxlength="100">
                    </td>
                  </tr>
                  <tr> 
...
<textarea rows="8" name="Content" cols="45"></textarea>
				   ...
				   <tr> 
                    <td height="22" bgcolor="#A4B6D7"> 
                      <div align="center">英文内容:</div></td>
                    <td>
<textarea rows="8" name="enContent" cols="45"></textarea>
                    </td>
                  </tr>
                  <tr> 
