          ...
          <form method="post" action="Admin_editAffiche.asp?mark=southidc">
            ...
            <td><div align="center"> 
                <table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#ECF5FF">
				  ...
				  <tr> 
                    <td width="27%" height="25" bgcolor="#A4B6D7"> <div align="center">英文标题:</div></td>
                    <td width="73%"> <input name="enTitle" type="text" id="Title" value="<%=rs("enTitle")%>" size="45" maxlength="100"> 
                    </td>
                  </tr>
                  <tr> 
				   ...
				   <tr> 
                    <td height="22" bgcolor="#A4B6D7"> <div align="center">英文内容:</div></td>
                    <td><textarea rows="8" name="enContent" cols="45"><%=rs("enContent")%></textarea> 
                    </td>
                  </tr>
                  <tr> 
