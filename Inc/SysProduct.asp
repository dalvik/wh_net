...
sub SearchResultContent()
	...
	do while not rsSearch.eof
		...
		strTemp= strTemp & "<table width=100% border=0 cellspacing=3 cellpadding=0>"
                ...
                strTemp= strTemp & "<td height=20>产品信息：</td>"
                strTemp= strTemp & "<td>"
  ...
  <form method="Get" name="myform" action="search.asp">
    ...
    <tr>
      <td height="28"> 
       ...
       &nbsp;&nbsp; <input type="submit" name="Submit"  value="搜索" style="BORDER-RIGHT: #B7DAEF 1px solid; BORDER-TOP: #B7DAEF 1px solid; BORDER-LEFT: #B7DAEF 1px solid; BORDER-BOTTOM: #B7DAEF 1px solid " color:#0099FF> </td>
    </tr>
  </form>
</table>
<%
