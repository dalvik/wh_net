...
<table  width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr> 
    <td><table width="100%" border="0" cellpadding="0" cellspacing="0">
        <tr> 
          <td class="title_left" height="34" align="center" ><span class="STYLE1">新闻搜索</span></td>
        </tr>
        <tr> 
  ...
  <tr> 
    <td><table width="100%" border="0" cellpadding="0" cellspacing="0">
        <tr> 
          <td class="title_left" height="34" colspan="2" align="center"><span class="STYLE1">最新新闻</span></td>
        </tr>
<%
t=0
...
%>
  ...
  <tr>
    <td><table width="100%" border="0" cellpadding="0" cellspacing="0">
        <tr> 
          <td class="title_left" width="82%" align="center" ><span class="STYLE1">热门新闻</span></td>
